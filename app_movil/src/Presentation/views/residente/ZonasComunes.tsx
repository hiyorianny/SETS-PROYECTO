...
const ZonasComunes = () => {
  ...
  const submitSolicitud = async () => {
    ...
    try {
      const response = await fetch('http://192.168.1.100:3000/api/reservar-zona', {
        method: 'POST',
        headers: {
  ...
  const updateSolicitud = async () => {
    ...
    try {
      ...
      const deleteResponse = await fetch('http://192.168.1.100:3000/api/cancelar-reserva', {
        method: 'DELETE',
        headers: {
          'Content-Type': 'application/json',
        },
      ...
      const createResponse = await fetch('http://192.168.1.100:3000/api/reservar-zona', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
      ...
      Alert.alert(
        ...
        [
          ...
          },
          {
            text: 'Eliminar',
            onPress: async () => {
              const response = await fetch('http://192.168.1.100:3000/api/cancelar-reserva', {
                method: 'DELETE',
                headers: {
                  'Content-Type': 'application/json',
                },
