...
<body>
  <header>
        ...
        <br><br>
        <br><br>
      <center>  <h1 class="responsive-title"><b>Manual de Ayuda!</b></h1></center>
        <br>
        <center>
            <div class="page-container">
                <section class="document-section">
                    ...
                    <div class="document-content">
                        <iframe src="../../Documentacion-SETS/sexto trimestre/MANUALES/Manuales de usuario/manualAdmin .pdf" style="width: 100%; height: 1800px;" frameborder="0"></iframe>
                    </div>
                </section>
            </div>
        </center>
